...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        copyrightLabel->setText(QStringLiteral("Copyright &copy; 2014 The Instantcoin Core developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Instantcoin Core", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Instantcoin Core</b> version", 0));
