...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        labelBalance->setText(QStringLiteral("0 BTI"));
        ...
        labelUnconfirmed->setText(QStringLiteral("0 BTI"));
        ...
        labelImmature->setText(QStringLiteral("0 BTI"));
        ...
        labelTotal->setText(QStringLiteral("0 BTI"));
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Bitcoin network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        labelImmatureText->setText(QApplication::translate("OverviewPage", "Abstract:", 0));
#ifndef QT_NO_TOOLTIP
        labelImmature->setToolTip(QApplication::translate("OverviewPage", "Mined balance that s stll abstract", 0));
#endif // QT_NO_TOOLTIP
