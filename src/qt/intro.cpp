...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Instantcoin"),
     ...
     * override -datadir in the instantcoin.conf file in the default data directory
     * (to be consistent with instantcoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
