...
#define PACKAGE_BUGREPORT "info@instantcoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Instantcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Instantcoin Core 0.9.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "instantcoin"
